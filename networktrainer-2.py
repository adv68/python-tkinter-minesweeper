...
if __name__ == "__main__":
    trainingdata = pd.read_csv("trainingdata-2.csv")
    trainingdata.head()

    td_in = trainingdata.iloc[:, 0 : 25].values
    td_out = trainingdata.iloc[:, 25 : 26].values

    # attempt 1 - 250 epochs
    # result: failure
    ...
    # attempt 1
    #model.save("keras_model-2")
    # attempt 2
    #model.save("keras_model2-2")
    # attempt 3
    #model.save("keras_model3")
    # attempt 4
    #model.save("keras_model4")
    # attempt 5 - 97%
    #model.save("keras_model5-2")
    # attempt 6 - max 95%
    #model.save("keras_model6-2")
    # attempt 7
    model.save("keras_model7-2")
